...
HealBot_GlobalsDefaults = {
    ...
    WatchHoT = {
        ["DRUI"] = {
            [HEALBOT_DIVINE_GUARDIAN]=3,
            [HEALBOT_DEATH_WISH]=3,
            [HEALBOT_ENRAGE]=3,
            [HEALBOT_OWLKIN_FRENZY]=3,
            [HEALBOT_HYSTERIA]=3,
            [HEALBOT_DEVIOUS_MINDS]=3,
            [HEALBOT_METAMORPHOSIS]=3,
            [HEALBOT_AVENGING_WRATH]=3,
            [HEALBOT_SIPHONED_POWER]=1,
            [HEALBOT_PAIN_SUPPRESSION]=3,
            [HEALBOT_POWER_INFUSION]=3,
            [HEALBOT_GUARDIAN_SPIRIT]=3,
            [HEALBOT_RENEW]=2,
            [HEALBOT_ABOLISH_DISEASE]=2,
            ...
            [HEALBOT_HANDOFPROTECTION]=3,
            [HEALBOT_FEAR_WARD]=3,
            [HEALBOT_BLESSED_HEALING]=1,
            [HEALBOT_IMPROVED_LAY_ON_HANDS]=3,

...
local HealBot_Options_Class_HoTctlName_List = {
    ...
    [HEALBOT_DEATH_WISH]=HEALBOT_WARRIOR,
    [HEALBOT_ENRAGE]=HEALBOT_WARRIOR,
    [HEALBOT_METAMORPHOSIS]=HEALBOT_WARLOCK,
    [HEALBOT_DEVIOUS_MINDS]=HEALBOT_WARLOCK,
    [HEALBOT_AVENGING_WRATH]=HEALBOT_PALADIN,
    [HEALBOT_OWLKIN_FRENZY]=HEALBOT_DRUID,
    [HEALBOT_HYSTERIA]=HEALBOT_DEATHKNIGHT,
    [HEALBOT_SIPHONED_POWER]=HEALBOT_MAGE,
